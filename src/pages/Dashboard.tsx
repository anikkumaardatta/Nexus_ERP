    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          <GlassCard key={i} className="p-6 relative overflow-hidden group hover:scale-[1.02] transition-all duration-300">
            <div className={cn(
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <GlassCard className="lg:col-span-2 p-8 overflow-hidden">
          <div className="flex items-center justify-between mb-8">
             <div>
                <h3 className="text-xl font-bold text-slate-900 dark:text-white">Revenue Stream</h3>
                <p className="text-xs text-slate-500 font-medium uppercase tracking-widest mt-1">Weekly Performance Overview</p>
             </div>
        ...
        <GlassCard className="p-8">
           <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-1">Return Analytics</h3>
           <p className="text-xs text-slate-500 font-medium uppercase tracking-widest mb-8">Performance breakdown</p>
           ...
           <div className="h-64 relative">
             ...
             <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                ...
                <span className="text-[10px] font-bold text-rose-500 uppercase">Return Rate</span>
             </div>
           </div>
              ...
              {returnData.map((item) => (
                <div key={item.name} className="flex items-center justify-between group">
                   <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-bold text-slate-500 dark:text-slate-400 group-hover:text-indigo-500 dark:group-hover:text-white transition-colors">{item.name}</span>
                   </div>
                   <span className="text-sm font-black text-slate-700 dark:text-white">{item.value}%</span>
                </div>
              ))}
           </div>
        </GlassCard>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <GlassCard className="p-8">
           <div className="flex items-center justify-between mb-8">
              <h3 className="text-xl font-bold text-slate-900 dark:text-white">Courier Performance</h3>
        ...
        <GlassCard className="p-8">
           <div className="flex items-center justify-between mb-8">
              <h3 className="text-xl font-bold text-slate-900 dark:text-white">Inventory Threshold</h3>
           ...
           <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/5 group hover:bg-slate-100 dark:hover:bg-white/[0.04] transition-all">
                   <div className="flex items-center gap-4">
                      ...
                      <div>
                         ...
                         <p className="text-[10px] font-mono text-slate-500 mt-1">Stock Left: {item.stock}</p>
                      </div>
                   </div>
                   <button className="p-2 glass text-indigo-500 dark:text-indigo-400 hover:text-indigo-600 dark:hover:text-white transition-all rounded-lg border-slate-200 dark:border-white/5">
